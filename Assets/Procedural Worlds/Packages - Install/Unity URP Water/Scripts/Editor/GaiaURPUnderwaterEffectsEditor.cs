...
namespace Gaia
{
    [CustomEditor(typeof(GaiaURPUnderwaterEffects))]
    public class GaiaURPUnderwaterEffectsEditor : PWEditor
    {
        private EditorUtils m_editorUtils;
        private GaiaURPUnderwaterEffects m_profile;
        private GaiaConstants.EnvironmentRenderer m_renderPipeline;

        private void OnEnable()
        {
            //Get Profile object
            m_profile = (GaiaURPUnderwaterEffects)target;
